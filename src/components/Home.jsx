...
const handleDownload = () => {
  window.open('https://drive.google.com/file/d/1uA0I0arxUQ9EcH5xEbjzsvGvjCAypmJl/view?usp=drive_link', '_blank');
};
...
const skillsData = [
  ...
  { icon: Smartphone, label: "Devops", color: "bg-[[#CDEA68]" }
];

const socialLinks = [
  { icon: Github, href: "https://github.com/Sumit7521", label: "GitHub" },
  { icon: Linkedin, href: "https://www.linkedin.com/in/sumit-sharma-818198343/", label: "LinkedIn" },
  { icon: Mail, href: "mailto:sumit140803@gmail.com", label: "Email" }
];
          ...
          <div className="space-y-8 z-40">
            ...
            <motion.div variants={itemVariants} className="z-40">
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white leading-tight z-40">
                <span className="text-[#CDEA68] z-40">Sumit</span>
                <br />
                <span className="text-white z-40">Sharma</span>
              </h1>
            </motion.div>
