...
const About = forwardRef((props, ref) => {
    ...
    const sentences = [
        "I am a Full Stack Developer with experience in Creative Frontend, Backend, and Devops.",
        "I specialize in React.js, Three.js , R3F, GSAP for Frontend, Node.js & Express.js for Backend, and MongoDB for Databases.",
