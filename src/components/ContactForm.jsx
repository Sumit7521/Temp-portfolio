    ...
    return (
        ...
        >
            ...
            <motion.div 
                ...
                variants={itemVariants}
            >
                <a href="https://github.com/Sumit7521" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
                    <Github className="w-6 h-6 text-white hover:text-[#E7FF93] transition-colors duration-300" />
                </a>
                <a href="https://www.linkedin.com/in/sumit-sharma-818198343/" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
